...
class Davinci3:
    def __init__(self, credentials):
        ...
        self.deployment_name = credentials["chatengine"]["AZURE_OPENAI_DEPLOYMENT_NAME_DAVINCI3"]
        self.messages = []
        self.max_token_length_input = 2048
        self.max_token_length_total = 4096
        self.prompt = "You are an excellent chat bot, named HSR. " + \
    ...
    def generate(self, message):
        ...
        response = openai.Completion.create(engine=self.deployment_name,
...
class ChatGPT:
    def __init__(self, credentials):
        ...
        openai.api_type = 'azure'
        openai.api_version = '2022-12-01'
        self.deployment_name = credentials["chatengine"]["AZURE_OPENAI_DEPLOYMENT_NAME_CHATGPT"]
        self.messages = []
        self.max_token_length = 4096
        self.system_message = "<|im_start|>system\n" + \
            "You are an excellent chat bot, named HSR. " + \
